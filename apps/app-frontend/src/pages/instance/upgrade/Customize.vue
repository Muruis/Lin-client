...
const messages = defineMessages({
	...
	description: {
		...
		defaultMessage: 'Choose how aggressively Lin Client should update content in this instance.',
	},
	...
	customDescription: {
		...
		defaultMessage:
			'Fix exact versions for selected content and let Lin Client solve the remaining dependency graph.',
	},
	...
	searchLimitBody: {
		...
		defaultMessage:
			"Lin Client couldn't find a solution within the search limit. Try relaxing one of your custom choices.",
	},
	conflictTitle: {
