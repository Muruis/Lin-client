...
const messages = defineMessages({
	...
	stateTitle: {
		...
		defaultMessage: 'Error initializing Lin Client',
	},
	networkIssues: { id: 'app.error.network-issues', defaultMessage: 'Network issues' },
	networkDescription: {
		id: 'app.error.network-description',
		defaultMessage:
			'Lin Client had trouble connecting to Microsoft services. This is often caused by a poor connection. Try again, and use our support article if the issue persists.',
	},
	hostsDescription: {
	...
	permissionsDescription: {
		...
		defaultMessage:
			'Lin Client cannot write to the selected directory. Adjust its permissions and try again, or cancel the directory change.',
	},
	...
	directoryDescription: {
		...
		defaultMessage:
			'Lin Client cannot migrate to the selected directory. Contact support for help or cancel the directory change.',
	},
	retryDirectory: {
	...
	stateDescription: {
		...
		defaultMessage:
			'Lin Client failed to load correctly. A file may be corrupted or an essential file may be missing.',
	},
	stateFixIntro: {
	...
	loaderDescription: {
		...
		defaultMessage: 'Lin Client could not find a loader version for this instance.',
	},
	loaderFix: {
