...
const messages = defineMessages({
	...
	axolotlDataDirectory: {
		...
		defaultMessage: 'Lin Client data directory',
	},
	...
	minecraftDirectoriesDescription: {
		...
		defaultMessage:
			'Add one or more .minecraft folders for instances that use an external game directory. These folders are kept separate from Lin Client data.',
	},
	...
	appCacheDescription: {
		...
		defaultMessage:
			'Lin Client caches data to speed up loading. Purging it forces the app to reload data and may temporarily slow the app down.',
	},
	downloadMirrors: {
