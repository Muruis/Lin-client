...
export const settingsSearchEntries: SettingsSearchEntry[] = [
	{
		...
		description: message(
			...
			'Select your preferred color theme for Lin Client.',
		),
	},
	{
	...
	},
	{
		...
		label: message(
			...
			'Choose how to close Lin Client',
		),
		keywords: [
	...
	},
	{
		...
		label: message('app.settings.resources.axolotl-data-directory', 'Lin Client data directory'),
	},
	{
