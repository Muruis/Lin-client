...
const messages = defineMessages({
	...
	description: {
		...
		defaultMessage: 'Choose which launcher versions Lin Client receives.',
	},
	channelLabel: {
	...
	upToDate: {
		...
		defaultMessage: 'Lin Client is up to date.',
	},
	disabled: {
	...
	restartDescription: {
		...
		defaultMessage:
			'Restart Lin Client now to start using the new update channel, or restart manually later.',
	},
	...
	databaseOperationActiveTarget: {
		...
		defaultMessage:
			'Cannot overwrite the database currently in use. Restart Lin Client and switch channels first.',
	},
	databaseOperationFailed: {
		id: 'app.settings.updates.database-operation.failed',
		defaultMessage:
			'The database could not be copied. Please make sure Lin Client is not using the target database.',
	},
