...
const messages = defineMessages({
	...
	surveyDescription: {
		...
		defaultMessage: 'Help us improve Lin Client',
	},
	licenseAttribution: {
	...
	attribution: {
		...
		defaultMessage: 'Lin Client is a modified version of the open-source Modrinth codebase.',
	},
	notAffiliated: {
		id: 'app.settings.about.not-affiliated',
		defaultMessage:
			'Modrinth is a trademark of Rinth, Inc. Lin Client is not affiliated with or endorsed by Rinth, Inc.',
	},
	originalSource: {
