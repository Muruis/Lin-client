...
const messages = defineMessages({
	...
	response: {
		...
		defaultMessage:
			'Since Lin Client was promoted on video platforms, we have received far more love and attention than we expected, along with many thoughtful suggestions and high-quality reports.',
	},
	thanks: {
	...
	feedbackSuffix: {
		...
		defaultMessage: '. We look forward to improving Lin Client together!',
	},
})
