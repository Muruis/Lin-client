...
export const onboardingMessages = defineMessages({
	...
	translationTitle: {
		...
		defaultMessage: 'Translation, the Lin Client way',
	},
	...
	updatesDescription: {
		...
		defaultMessage: 'Choose when Lin Client checks for updates and whether it installs them for you.',
	},
	...
	mascotAlt: { id: 'app.onboarding.mascot-alt', defaultMessage: 'Lin Client guide' },
})
