...
const messages = defineMessages({
	...
	playInsights: { id: 'app.home.widgets.play-insights', defaultMessage: 'Total playtime' },
	playInsightsDescription: {
		id: 'app.home.widgets.play-insights-description',
		defaultMessage: 'A visual summary of your real recorded playtime.',
	},
	pinnedInstances: {
...
const catalogSections = computed(() => [
	{
		...
		items: [
			...
			{
				kind: 'play-insights' as const,
				label: formatMessage(messages.playInsights),
				description: formatMessage(messages.playInsightsDescription),
				icon: ClockIcon,
			},
		],
	},
