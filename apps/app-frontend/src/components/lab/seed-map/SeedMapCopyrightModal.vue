...
const messages = defineMessages({
	...
	engineBody: {
		...
		defaultMessage:
			'Biome, terrain, spawn, and structure data is generated locally with cubiomes, Copyright (c) 2020 Cubitect, provided under the MIT License, together with the Lin Client native integration.',
	},
	viewCubiomes: {
	...
	disclaimerBody: {
		...
		defaultMessage:
			'Minecraft is a trademark of Mojang Synergies AB. Lin Client is not affiliated with or endorsed by Mojang or MinecraftSearch.',
	},
})
