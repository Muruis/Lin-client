...
const messages = defineMessages({
	...
	disclaimerBody: {
		...
		defaultMessage:
			'Minecraft assets are Copyright Mojang Studios / Microsoft and are used only to identify compatible content. Lin Client is not affiliated with or endorsed by Mojang Studios or Microsoft.',
	},
})
