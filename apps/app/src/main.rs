...
fn main() {
    ...
    */
    ...
    tracing::info!("Initialized tracing subscriber. Loading Lin Client!");
    ...
    match app {
        Ok(app) => {
            app.run(|app, event| {
                ...
                // Automatic application updates are intentionally disabled for Lin Client.
                #[cfg(any())]
            ...
            #[cfg(target_os = "windows")]
            {
                ...
                if format!("{e:?}").contains(
                    ...
                    DialogBuilder::message()
                        .set_level(MessageLevel::Error)
                        .set_title("Initialization error")
                        .set_text("Your Microsoft Edge WebView2 installation is corrupt.\n\nMicrosoft Edge WebView2 is required to run Lin Client.\n\nRepair or reinstall the Microsoft Edge WebView2 Runtime, then start Lin Client again.")
                        .alert()
                        .show()
                        .unwrap();
